...
" id="top">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden mt-5">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('home') }}" :active="request()->routeIs('home')" class=" x-jet-nav-link-mobile text-center">
                {{ __('Accueil') }}
            </x-jet-responsive-nav-link>

            <x-jet-responsive-nav-link href="{{ route('skills') }}" :active="request()->routeIs('skills')" class="x-jet-nav-link-mobile text-center">
                {{ __('Skills') }}
            </x-jet-responsive-nav-link>

            <x-jet-responsive-nav-link href="{{ route('portfolio') }}" :active="request()->routeIs('portfolio')" class="x-jet-nav-link-mobile text-center">
                {{ __('portfolio') }}
            </x-jet-responsive-nav-link>

            <x-jet-responsive-nav-link href="{{ route('contact') }}" :active="request()->routeIs('contact')" class="x-jet-nav-link-mobile text-center">
                {{ __('Contact') }}
            </x-jet-responsive-nav-link>
        </div>
